...
import io
import uvicorn
from .sensor_noise import add_sensor_noise_pil
...
buf = add_sensor_noise_pil(pil, iso=iso, prnu_strength=prnu_strength, read_noise_sigma=read_noise_sigma, seed=seed)
